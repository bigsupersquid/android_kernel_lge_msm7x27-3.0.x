...
#include <../arch/arm/mach-msm/include/mach/usbdiag.h>
#include <asm/current.h>
#include <linux/timer.h>
#include <linux/kthread.h>
#include <../arch/arm/mach-msm/include/mach/lg_diagcmd.h>
...
#include <../arch/arm/mach-msm/include/mach/lg_diag_unifiedmsgtool.h> //#ifdef LG_SMS_PC_TEST
#include <../arch/arm/mach-msm/include/mach/lg_diagcmd.h>
#include <linux/slab.h>
#include <../arch/arm/mach-msm/include/mach/lg_diag_udm.h>
#include <../arch/arm/mach-msm/include/mach/lge_diag_eri.h>

// LG_FW : 2011.07.07 moon.yongho : saving webdload status variable to eMMC. -----------[[
#include <../arch/arm/mach-msm/include/mach/lg_diag_dload.h>
...
static int diagchar_ioctl_servie(unsigned int iocmd, unsigned long ioarg)
{
	...
	if (iocmd == DIAG_IOCTL_COMMAND_REG) {
		...
		for (i = 0; i < diag_max_reg; i++) { // REG_TABLE_SIZE -> diag_max_reg
