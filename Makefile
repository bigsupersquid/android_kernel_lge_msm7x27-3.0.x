...
AFLAGS_MODULE   =
LDFLAGS_MODULE  =
CFLAGS_KERNEL	= -mfloat-abi=softfp -ffast-math -mfpu=vfp -pipe
AFLAGS_KERNEL	= -mfloat-abi=softfp -ffast-math -mfpu=vfp -pipe
...
CFLAGS_V6K = -march=armv6k -mtune=arm1136j-s -mfpu=vfp -funsafe-math-optimizations
CFLAGS_MODULO = -fmodulo-sched -fmodulo-sched-allow-regmoves
KERNEL_MODS = $(CFLAGS_V6K) $(CFLAGS_MODULO)
